function kaplan_meier_data_analysis(filename_km, outputDir, numericData, geneNames, patientsNames, ....
...
stats30 = KM_support_functions.get_log_rank_two_grps(patientsNamesKM, ...
    timeData, cens, patientsNamesTop30, patientsNamesLow70, timeCutOff, title);
...
stats20 = KM_support_functions.get_log_rank_two_grps(patientsNamesKM,...
    timeData, cens, patientsNamesTop20, patientsNamesLow80, timeCutOff, title);
...
stats10 = KM_support_functions.get_log_rank_two_grps(patientsNamesKM,...
    timeData, cens, patientsNamesTop10, patientsNamesLow90, timeCutOff, title);
...
stats80 = KM_support_functions.get_log_rank_two_grps(patientsNamesKM,...
    timeData, cens, patientsNamesTop80, patientsNamesLow20, timeCutOff, title);
...
KM_support_functions.kaplan_meier_gene1_vs_gene2_encapsulated(filename_km, fileOutput, outputDir, ...
	gene_name, numericData, patientsNames, patientsNamesTop20, patientsNamesLow80, patientsNamesKM,...
...
KM_support_functions.kaplan_meier_gene1_vs_gene2_encapsulated(filename_km, fileOutput, outputDir, ...
	gene_name, numericData, patientsNames, patientsNamesTop80, patientsNamesLow20, patientsNamesKM,...
...
KM_support_functions.kaplan_meier_gene1_vs_gene2_encapsulated(filename_km, fileOutput, outputDir, ...
	gene_name, numericData, patientsNames, patientsNamesTop30, patientsNamesLow70, patientsNamesKM,...
...
KM_support_functions.kaplan_meier_gene1_vs_gene2_encapsulated(filename_km, fileOutput, outputDir, ...
	gene_name, numericData, patientsNames, patientsNamesTop70, patientsNamesLow30, patientsNamesKM,...
